...
@section('content')
    <div class="mdk-drawer-layout__content page">
                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Loads') }}</li>
                        </ol>
                    </nav>
                    <h1 class="m-0"> {{ __('Loads') }} </h1>
                </div>
                <a href="{{ route('loads.create') }}" class="btn btn-success ml-3">{{ __('Create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
        ...
        <div class="container-fluid page__container">
                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('loads.edit', $load->id) }}" class="btn btn-sm btn-link">
            ...
            <div class="mt-4">
                {{ $loads->links('dashboard.pagination.custom') }}
            </div>
        </div>
