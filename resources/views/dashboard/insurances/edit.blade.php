                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="city_id" name="city_id" data-toggle="select" class="form-control select2">
                                ...
                                @forelse($cities as $city)
                                    <option value="{{ $city->id }}" {{ old('city_id', $insurance->city_id) == $city->id ? 'selected' : '' }}> {{ $city->name }} </option>
                                @empty
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="price" name="price" type="text" class="form-control" placeholder="{{ __("Price") }}" value="{{ old("price", $insurance->price) }}">
                            </div>
                        </div>
                    </div>
